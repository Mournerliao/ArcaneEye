...
GitHub Issues — 使用 `gh` CLI 管理。See `harness/agents/issue-tracker.md`.

### Triage labels

五个标准标签：`needs-triage`、`needs-info`、`ready-for-agent`、`ready-for-human`、`wontfix`。See `harness/agents/triage-labels.md`.

### Domain docs

Single-context — 根目录 `CONTEXT.md` + `docs/adr/`。See `harness/agents/domain.md`.
