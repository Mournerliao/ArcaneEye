...
Arcane intelligence. The interface should feel like consulting a Hextech oracle: mystical, precise, authoritative. Data presented as divination, not spreadsheets. The LoL universe's Hextech aesthetic (arcane purple, gold circuits, crystalline forms) informs the visual language without cosplaying as a game UI.
...
2. **Arcane presence, not decoration**: The mystical aesthetic comes from color (deep purples, warm golds), light (glows, subtle radiance), and motion (smooth reveals, fade-outs), not from ornamental borders or fantasy textures.
